...
class PublicProfilePage extends StatefulWidget {
  ...
  const PublicProfilePage({super.key, required this.userId, this.userName});
...
class _PublicProfilePageState extends State<PublicProfilePage> {
  ...
  Future<void> _loadProfile() async {
    ...
    try {
      final response = await ApiService.getProfileById(widget.userId);
  ...
  // Helper method to get social media URL
